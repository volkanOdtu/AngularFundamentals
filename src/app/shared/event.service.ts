...
{    
    ...
    getEvents():Observable<IEvent[]>
    {
      ...
      /*
        ...
        //100 milisecond sonra datayi ,stream e ekliyorz
        setTimeout(() =>{ subject.next(events) ; subject.complete();} ,100 )
        return subject; //eskiden direk events i donduruyoduk
        */
        //Eventually bu event ler AJAX call ile alinacak ,simdilik sabit bir objeden alalim
        //return events;
    }
    ...
    getEvent(id:number):Observable<IEvent>
    {
       ...
       .pipe(catchError(this.handleError<IEvent>('getEvents')));
        ...
        //Daha sonra bu AJAX call olucak simdilik ,asagidaki array den alalim 
    ...
    searchSessions(searchTerm:string):Observable<ISession[]>{
      ...
      //buldugumuz session lara eventID atiyoruz bu arada
